...
(function() {
  ...
  function isValidUrl(url) {
    console.log('[Vertex AI Proxy Shim] Checking URL:', url);
    try {
      ...
      // Live API (WebSocket)
      if (url === 'wss://aiplatform.googleapis.com//ws/google.cloud.aiplatform.v1beta1.LlmBidiService/BidiGenerateContent' || url.includes('LlmBidiService')) {
        console.log('[Vertex AI Proxy Shim] Matched Live API URL!');
        return true;
      }
      ...
      try {
        ...
        const proxyFetchOptions = {
          ...
          headers: {
            ...
            'X-App-Proxy': 'AzS17FdpfRFmrJbXDwQi-X01GxTTLhxf',
          },
